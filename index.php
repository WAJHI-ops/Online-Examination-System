...
<!--<div class="jumbotron text-center">
  ...
  <p>E-examination</p>--> 
 <div class="jumbotron text-center" style="position: relative; text-align: left;">
  <img src="logo.png" alt="Online Exam Logo" style="width:130px; float:left; margin-right: 30px; margin-top: 10px;">
  <div style="margin-left: 130px;">
    <h1 style="text-align:left;">Online Examination</h1> 
    <p style="text-align:left;">E-quiz</p>
  </div>
</div>
  <!--  form>
...
<!--  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="Abdullah" width="400" height="300">
        <p><strong>M ABDULLAH BIN ABDUL AZIZ</strong></p>
        <p>Bahria university islamabad</p>
      </div>
    </div>  
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic.jpg" alt="Ibrahim" width="400" height="300">
        <p><strong>MUHAMMAD IBRAHIM</strong></p>
        <p>Bahria university islamabad</p>
      </div> -->
      <!-- <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic1.jpg" alt="Wajhi" width="400" height="300">
        <p><strong>WAJHI UR REHMAN</strong></p>
        <p>Bahria university islamabad</p>
      </div>-->
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="Abdullah" width="350" height="300">
        <p><strong>M ABDULLAH BIN ABDUL AZIZ</strong></p>
        <p>Bahria university islamabad</p>
      </div>
    </div>  
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic.jpg" alt="Ibrahim" width="350" height="300">
        <p><strong>MUHAMMAD IBRAHIM</strong></p>
        <p>Bahria university islamabad</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic1.jpg" alt="Wajhi" width="300" height="300">
        <p><strong>WAJHI UR REHMAN</strong></p>
        <p>Bahria university islamabad</p>
      </div>
    </div>
  ...
  <h2><span style="padding-left: 48px;">WHAT OUR USERS SAY</span></h2>
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>Adnan Jelani, Assistant Professor</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Ayesha Saleem, Teacher</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Kabir Bhatti, Teacher at Bahria University</span></h4>
      </div>
    </div>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>About Page</h2><br>
      <h4>Online examination System is conducting a test online to measure the knowledge of the participants on a given topic. In the older days everybody had to gather in a classroom at the same time to take an exam. With online examination students can give the exam online, in their own time and with their own device, regardless where they live. You only need a browser and internet connection. </h4><br>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Islamabad, Pakistan</p>
      <p><span class="glyphicon glyphicon-phone"></span> +92 3350540459 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> ropriabdullah@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(33.6844, 73.0479);
